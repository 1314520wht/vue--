			...
			<el-table :data="tableData" border style="width: 100%">
				...
				<el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" size="mini"  @click="fb()">发布任务</el-button>
                        <el-button type="primary" size="mini"  @click="tiji()">提交审核</el-button>
                    </template>
                </el-table-column>
			</el-table>
      <!-- 弹窗区域 -->
      <el-dialog :title="state ? '修改项目信息' : '查看单据' " :visible.sync="dialogFormVisible" width="500px">
        <el-form :model="form">
